...
struct Map_t {
	...
	template <typename DomainElement_> typename Eval_f<TypeMap_,DomainElement_>::T const &val () const { return m_values.template el<IndexIn_f<typename TypeMap_::Domain,DomainElement_>::V>(); }
	template <typename DomainElement_> typename Eval_f<TypeMap_,DomainElement_>::T &val () { return m_values.template el<IndexIn_f<typename TypeMap_::Domain,DomainElement_>::V>(); }
