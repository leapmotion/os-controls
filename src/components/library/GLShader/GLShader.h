...
public:
  ...
  GLuint ProgramHandle () const { return m_program_handle; }
  ...
  static GLuint CurrentlyBoundProgramHandle () {
    GLuint current_program;
    glGetIntegerv(GL_CURRENT_PROGRAM, reinterpret_cast<GLint *>(&current_program)); // We know that GL_CURRENT_PROGRAM is a valid param.
