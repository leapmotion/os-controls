...
ShapesLayer::ShapesLayer ()
  ...
  m_Width(640),
  m_Height(480),
  m_Image1(Resource<Leap::GL::Texture2>("rewind.png")),
  m_Image2(Resource<Leap::GL::Texture2>("playpause.png")),
  m_Image3(Resource<Leap::GL::Texture2>("fastforward.png")),
  m_time(0)
{
  m_shader = Resource<Leap::GL::Shader>("material");

  m_Sphere1.SetRadius(5);
  m_Sphere1.Material().Uniform<DIFFUSE_LIGHT_COLOR>() = Leap::GL::Rgba<float>(0.4f, 0.7f, 1.0f, 1.0f);
  m_Sphere1.Material().Uniform<AMBIENT_LIGHT_COLOR>() = Leap::GL::Rgba<float>(0.2f, 0.2f, 0.2f, 1.0f);
  m_Sphere1.Material().Uniform<AMBIENT_LIGHTING_PROPORTION>() = 0.3f;
  m_Sphere1.LocalProperties().AlphaMask() = 1.0f;

  m_Sphere2.SetRadius(5);
  m_Sphere2.Material().Uniform<DIFFUSE_LIGHT_COLOR>() = Leap::GL::Rgba<float>(1.0f, 0.7f, 0.4f, 1.0f);
  m_Sphere2.Material().Uniform<AMBIENT_LIGHT_COLOR>() = Leap::GL::Rgba<float>(0.2f, 0.2f, 0.2f, 1.0f);
  ...
  m_Rect.Material().Uniform<DIFFUSE_LIGHT_COLOR>() = Leap::GL::Rgba<float>(1.0f, 1.0f, 1.0f, 0.3f);
  m_Rect.Material().Uniform<AMBIENT_LIGHT_COLOR>() = Leap::GL::Rgba<float>(1.0f, 1.0f, 1.0f, 0.3f);
  m_Rect.Material().Uniform<AMBIENT_LIGHTING_PROPORTION>() = 0.9f;
  m_Rect.SetTexture(Resource<Leap::GL::Texture2>("playpause.png"));
  ...
  m_Cylinder.Material().Uniform<DIFFUSE_LIGHT_COLOR>() = Leap::GL::Rgba<float>(0.7f, 1.0f, 0.4f, 1.0f);
  m_Cylinder.Material().Uniform<AMBIENT_LIGHT_COLOR>() = Leap::GL::Rgba<float>(0.2f, 0.2f, 0.2f, 1.0f);
  ...
  m_Disk.Material().Uniform<DIFFUSE_LIGHT_COLOR>() = Leap::GL::Rgba<float>(1.0f, 1.0f, 0.3f, 1.0f);
  m_Disk.Material().Uniform<AMBIENT_LIGHT_COLOR>() = Leap::GL::Rgba<float>(1.0f, 1.0f, 0.3f, 1.0f);
  ...
  m_Box.Material().Uniform<DIFFUSE_LIGHT_COLOR>() = Leap::GL::Rgba<float>(0.3f, 1.0f, 1.0f, 1.0f);
  m_Box.Material().Uniform<AMBIENT_LIGHT_COLOR>() = Leap::GL::Rgba<float>(0.2f, 0.2f, 0.2f, 1.0f);
  ...
  m_PartialDisk.Material().Uniform<DIFFUSE_LIGHT_COLOR>() = Leap::GL::Rgba<float>(1.0f, 0.3f, 1.0f, 1.0f);
  m_PartialDisk.Material().Uniform<AMBIENT_LIGHT_COLOR>() = Leap::GL::Rgba<float>(1.0f, 0.3f, 1.0f, 1.0f);
  ...
  std::shared_ptr<Leap::GL::Texture2> frame_texture;
  {
    // Generate a texture procedurally for use in TexturedFrame.
    GLsizei width = 4;
    GLsizei height = 4;
    Leap::GL::Texture2Params params(width, height, GL_RGB8);
    ...
    Leap::GL::Texture2PixelData pixel_data(GL_RGB, GL_UNSIGNED_BYTE, pixels.data(), pixels.size()*sizeof(RgbPixel));
    ...
    frame_texture = std::make_shared<Leap::GL::Texture2>(params, pixel_data);
  }
  ...
  
  {
    ...
    m_DropShadowContrastBackground.Material().Uniform<AMBIENT_LIGHT_COLOR>() = Leap::GL::Rgba<float>(0.75f, 0.75f, 0.75f, 1.0f);
