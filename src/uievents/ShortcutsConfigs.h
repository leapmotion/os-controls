...
namespace configs {
  ...
  const Rgba<float> MEDIA_BASE_COLOR(0.59f,0.59f,0.59f);
  const Rgba<float> MEDIA_SELECTED_COLOR(0.5f, 0.83f, 0.11f);
  const float MEDIA_BASE_ALPHA_MASK = 1.0f;
  const float MEDIA_SELECTED_ALPHA_MASK = 0.7f;
}
